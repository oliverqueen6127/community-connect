  ...
  return (
    <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-1 p-5 flex flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-1.5">
        ...
        {job.remote && <Badge variant="teal">Remote</Badge>}
      ...
      <div className="flex gap-2 mt-auto">
        ...
        <button className="px-4 py-2.5 text-sm font-medium text-[#1B4332] border border-[#1B4332] rounded-xl hover:bg-[#1B4332] hover:text-white transition-colors">
          Details
        </button>
      </div>
    </div>
